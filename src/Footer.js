    ...
    <div className="footer-container">
      <div className="bottom-side-container">
        <div className="copyright-statement-container">
          ...
          <p className="copyright-statement">© 2023 Ammar Nassri</p>
        </div>
        <div className="social-media-container">
          <a
            href="https://twitter.com/ammar_nassri"
            target="_blank"
            rel="noreferrer"
          >
            <i className="social-media fab fa-twitter"></i>
          </a>
          <a href="https://github.com/anassri" target="_blank" rel="noreferrer">
            <i className="social-media fab fa-github"></i>
          </a>
          <a
            href="https://www.linkedin.com/in/anassri/"
            target="_blank"
            rel="noreferrer"
          >
            {" "}
          ...
          <a href="mailto:ar.nassri@gmail.com" target="_blank" rel="noreferrer">
            {" "}
            <i className="social-media fas fa-envelope"></i>
          </a>
        </div>
