        ...
        <div className="portfolio-container">
            <div className="portfolio-body-container">
                <div className="left-portfolio-container">
                    <PortfolioEntry logo={logos[0]} screen={screens[0]} caption={captions[2]} github={githubs[2]} appLink={appLinks[2]}/>
                </div>
                <div className="right-portfolio-container">
                    <PortfolioEntry logo={logos[3]} screen={screens[3]} caption={captions[3]} github={githubs[3]} appLink={appLinks[3]}/>
                </div>
            </div>
        </div>
    )
